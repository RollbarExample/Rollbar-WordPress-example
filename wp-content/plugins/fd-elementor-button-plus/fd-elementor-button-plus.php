...
add_action( 'admin_notices', 'plugin_feedback' );
function plugin_feedback(){
	if ( ! is_admin() ) {
			return;
		}
		...
		if ( is_plugin_active( 'fd-elementor-button-plus/fd-elementor-button-plus.php' ) ) {
			echo sprintf('<div class="notice notice-info"><p>Give Best<a href="https://wordpress.org/plugins/fd-elementor-button-plus/" target="_blank">Feedback And Ratings</a> to our  <strong> Elementor Button Plus Plugin</strong></p></div>','FD_EAW');
		}
}
